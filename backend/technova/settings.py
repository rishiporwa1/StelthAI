...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/day',
        'user': '1000/day',
        'contact': '5/hour',     # custom scope for contact form
    }
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='TechNova <noreply@technova.com>')
CONTACT_RECIPIENT_EMAIL = config('CONTACT_RECIPIENT_EMAIL', default='info@technova.com')
